...
summary: >
  本讲义为2022年五一培尖刷题班（4.30）的高考数学专题，聚焦解析几何（抛物线、椭圆、圆）的综合应用与解题技巧。内容涵盖圆锥曲线与直线的位置关系、切线问题、轨迹方程、面积最值、定值定点证明等核心题型，并涉及仿射变换、极坐标、几何转化等高级方法。题目来源包括历年自招、高考及竞赛改编题，难度层次分明，注重计算能力与几何直观的双重训练，适合拔高阶段学生系统突破解析几何难点。
